...
const AddProductDetail: React.FC<AddProductDetailProps> = ({ productId, onClose, setAddFormState, updateListProductDetail }) => {
    ...
    <div className="productDetail_add_box">
      <div className="form_box">
        ...
        <form className='add_form' onSubmit={handleSubmit}>
          <div>
            <label > Image: </label>
            <input type="file" name="image" onChange={handleChange} className='form_input' />
          </div>
          <div>
            <label > Name:
            </label>
            <input type="text" name="productDetailName" value={productDetail.productDetailName} onChange={handleChange} placeholder="Product Detail Name" className='form_input' />
          </div>
          <div>
            <label > Stock:
            </label>
            <input type="text" name="stock" value={productDetail.stock} onChange={handleChange} placeholder="Stock" className='form_input' />
          </div>
          <div>
            <label > Unit Price:
            </label>
          ...
          <div>
            ...
            <select name='colorId' value={productDetail.colorId} onChange={handleChange} className='form_select'>
              {
          ...
          <div>
            ...
            <select name='configId' value={productDetail.configId} onChange={handleChange} className='form_select'>
              {
